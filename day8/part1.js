...
function findAntinodes (a, b) {
    ...
    let antinodeCandidate = [(a[0]+distance[0]), (a[1]+distance[1])];

    if (antinodeCandidate[0] >= 0 && antinodeCandidate[1] >= 0 && antinodeCandidate[0]<map.length && antinodeCandidate[1] < map[0].length) {
